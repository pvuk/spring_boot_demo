...
public class CardType {
	...
	@Id
	@Field(value = "CARD_TYPE_ID", order = 1)											private String cardTypeId;
	...
	@Field(value = "IS_VERTUAL_CARD", order = 5)										private boolean isVertualCard;
	
	@Field(value = "COMMENTS", order = 6)												private String comments;
