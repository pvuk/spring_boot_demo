 ...
 * 	<li>follow steps in Document NEW_OPTION_REQUEST</li>
 * </ul>
...
public class OtherOption {
	 ...
	 * 2. When new option(NEW_OPTION_REQUEST_ID) is requested by user, need to CONFIRM_BY Developer and APPROVED_BY Manager ore REJECTED_BY TechSupport.
	 * 3. when new option(NEW_OPTION_REQUEST_ID) is requested by used IS_NEW = 'Y' and date should be from auditData.createDate(CurrentDate)
	 */
	 ...
	 * 3. Once NEW_OPTION is 'Y' then TEMPORARY_OPTION is 'N' in document NEW_OPTION_REQUEST and DESCRIPTION should be common color.
	 * 
	 */
	...
	/**
	 * 1. Once APPROVED is 'Y' in document 'NEW_OPTION_REQUEST' then TEMPORARY_OPTION is 'N' in 'NEW_OPTION_REQUEST' and NEW_OPTION in document 'OTHER_OPTION' is 'Y'.
	 */
